    ...
    <div class="mt-16">
        <div class="p-4 bg-white border-b sm:rounded-lg border-gray-100 mb-4">
            <div class="flex justify-between items-center">
                <h2 class="text-xl font-semibold">Kotak Masuk ({{ $contacts->count() }})</h2>
            </div>
            ...
            <div class="flex gap-2 mb-4">
                ...
                {{-- Search Box --}}
                <x-search-box placeholder="Cari Pesan Masuk..."></x-search-box>
            </div>
            ...
            <article x-data="{ open: false }"
                ...
                <div class="p-2 text-md col-span-5 text-stone-800">
                    <a href="{{ route('contact.detail', $contact->id) }}">
                        ...
                        <p class="hidden lg:line-clamp-2 text-sm text-stone-600">{{ $contact->message }}</p>
                    </a>
                ...
                <div class="hidden md:flex m-auto  text-stone-600 ">
                    ...
                    {{-- Hapus --}}
                    <form action="{{ route('contact.destroy', $contact->id) }}" method="POST" role="alert"
