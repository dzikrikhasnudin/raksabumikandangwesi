<x-guest-layout>
    ...
    <section class="bg-gradient-to-b from-primary-50 py-12 to-transparent dark:bg-gray-900">
        <div class="grid max-w-6xl px-6 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
